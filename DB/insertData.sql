...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Tubo com cerca de 1.5 metros que liga o reto ao anús.', 1,'indestino grosso','indestino delgado','esófago', 'fígado');
