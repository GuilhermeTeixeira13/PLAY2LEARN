...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Ao movimento da Terra em torno do seu proprio eixo chamamos de...',1,'movimento de rotacao','movimento do dia e da noite','movimento anual', 'movimento de translacao');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','O sol e ...',1,'uma estrela','um planeta principal','um planeta secundario', 'um universo');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Qual a duracao do movimento de rotacao da terra?', 1,'12 horas','365 dias','24 horas', '7 dias');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Ao movimento da Terra em torno do sol chamamos de...', 1,'movimento de translacao','movimento do dia e da noite','movimento anual', 'movimento de rotacao');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Qual a duracao do movimento de translacao da terra?', 1,'365 dias','12 horas','24 horas', '6 meses');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','O movimento de rotacao da terra da origem...', 2,'ao dia e noite','aos meses do ano','a noite', 'as estacoes do ano');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','O movimento de translacao da terra da origem...', 2,'as estacoes do ano','aos meses do ano','a noite', 'ao dia e a noite');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Identifique um planeta secundario', 2,'plutao','neptuno','jupiter', 'mercurio');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Os satelites naturais do sistema solar sao astros que giram a volta...', 2,'dos planetas principais','dos planetas secundarios','das estrelas', 'do sol');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','de manhã, o sol esta numa posicao...', 3,'nascente ou este','nascente ou sul','sul', 'poente ou este');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Ao meio dia, o sol esta numa posicao...', 3,'sul','nascente ou sul','nascente ou este', 'poente ou este');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Ao anoitecer, o sol esta numa posicao...', 3,'poente ou este','nascente ou sul','nascente ou este', 'sul');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','qual a representacao mais conhecida para indicar os pontos cardiais ?', 3,'Rosa dos ventos','Rosa dos cardeais','Rosa dos pontos cardeais', 'Rosa da orientacao');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Escolhe a opcao mais correta.As estrelas.. ', 3,'tem luz propria e emitem luz em todas as direcoes','nao tem luz propria e emitem luz em todas as direcoes','Nao tem luz propria e recebem e refletem luz que vem dos planetas', 'tem luz propria e recebem e refletem luz que vem das estrelas');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','Escolhe a opcao mais correta.Os planetas.. ', 3,'Nao tem luz propria e recebem e refletem luz que vem das estrelas','nao tem luz propria e emitem luz em todas as direcoes','nao tem luz propria e recebem e refletem luz que vem dos planetas', 'tem luz propria e emitem luz em todas as direcoes');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '1','O "Big Bang" foi uma gigantesca explosao que aconteceu ha cerca de 15 mil milhoes de anos e deu origem ao..','3','universo','sol','terra', 'sistema solar');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Qual o maior orgao do corpo humano?', 1,'pele','femur','intestino delgado', 'intestino grosso');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Como se chama os "buraquinhos" que temos na pele?', 1,'poros','ouvidos','pelos', 'narinas');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Produzem a saliva que é lançada no interior da boca.', 1,'galndulas salivares','boca','figado', 'estômago');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Tubo com cerca de 6 metros que liga o estômago ao intestino groso.', 1,'intestino delgado','ânus','esófago', 'faringe');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Tubo com cerca de 1,5 metros mais lardo que o intestino delgado, que se liga ao reto e ao ânus.', 1,'intestino grosso','pâncreas','esófago', 'figado');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Produz a bílis, um suco que fica armazena do na vesícula biliar.', 1,'figado','pâncreas','estômago', 'intestino grosso');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Armazena a bílis que é lançada nointestino delgado.', 1,'visícula bíliar','figado','reto', 'faringe');

-- Medium

INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','O que é o esqueleto?', 2,'um conjunto de ossos','um conjunto de orgaos','um conjunto de celulas', 'um conjunto de poros');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Como e que os ossos estao ligados entre si?', 2,'pelas articulações','pela coluna vertebral','pelas veias', 'pela omoplata');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','tubo de cerca de 25cm que se estende da faringe ate ao estomago', 2,'esófago','vesicula biliar','reto', 'estômago');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Faz parte do sistema respiratório.', 2,'os pulmões','o estomago','o sangue', 'o coração');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Onde se transforma o bolo alimentar.', 2,'o estomago','o sangue','o coração', 'os pulmões');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Quantas vertebras te a coluna vertebral?', 3,'33','36','39', '30');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Orgão que armazena a bílis que é lançada no indestino delgado?', 3,'vesícula biliar','faringe','figado', 'reto');
...
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Leva o alimento e o oxigénio a todas as células.', 3,'o sangue','o estomago','o coração', 'os pulmões');
INSERT INTO `questions_pt` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2','Faz circular o sangue.', 3,'o coração','o estomago','o sangue', 'os pulmões');
...
INSERT INTO `questions_eng` (`id`, `IDSubject`, `Question`, `Difficulty`, `RightAnswer`, `Wrong1`, `Wrong2`, `Wrong3`) VALUES (NULL, '2', 'Bag-shaped organ with muscular and elastic walls that contain gastric juice?', 3, 'stomach', 'mouth', 'large intestine', 'glândulas salivares')
